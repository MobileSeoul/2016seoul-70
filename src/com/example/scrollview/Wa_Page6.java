...
public class Wa_Page6 extends Activity {

	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.wm_page6);
	...
	public void callBtn(View v) {
		Intent myIntent = new Intent(Intent.ACTION_VIEW,
				Uri.parse("tel:02-789-5684"));
		startActivity(myIntent);
	}

	public void textBtn(View v) {
		Intent myIntent = new Intent(Intent.ACTION_VIEW,
				Uri.parse("http://www.63.co.kr/home/63CITY/skyart/intro.do"));
		startActivity(myIntent);
	}
