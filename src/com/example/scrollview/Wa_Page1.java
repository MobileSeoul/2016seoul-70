...
public class Wa_Page1 extends Activity {

	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
	    super.onCreate(savedInstanceState);
	    setContentView(R.layout.wm_page1);
	...
	public void callBtn(View v){
    	Intent myIntent = new Intent(Intent.ACTION_VIEW,
    			Uri.parse("tel:02-308-1071")
    			);
    	startActivity(myIntent);
    }
    public void textBtn(View v){
    	Intent myIntent = new Intent(Intent.ACTION_VIEW,
    			Uri.parse("http://semananji.seoul.go.kr/korean/studio/main.jsp")
    			);
    	startActivity(myIntent);
    }
