...
public class Mb_Page6 extends Activity {

	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.m_page6);
	...
	public void callBtn(View v){
    	Intent myIntent = new Intent(Intent.ACTION_VIEW,
    			Uri.parse("tel:02-2230-6600")
    			);
    	startActivity(myIntent);
    }
    public void textBtn(View v){
    	Intent myIntent = new Intent(Intent.ACTION_VIEW,
    			Uri.parse("http://www.caci.or.kr/Home/Intro/FoundationIntro.aspx")
    			);
    	startActivity(myIntent);
	}
